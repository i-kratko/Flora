...
const char *SSID = "smartlab_interns";
const char *PWD = "interns_2023";
...
// MQTT client
const char* mqtt_server = "59f428b0dd1844edb77cb79474f06657.s1.eu.hivemq.cloud"; // replace with your broker url
const char* mqtt_username = "niki123"; // replace with your Credential
const char* mqtt_password = "Amongus123";
